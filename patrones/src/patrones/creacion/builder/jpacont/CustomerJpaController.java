...
import patrones.creacion.builder.MicroMarket;
import patrones.creacion.builder.DiscountCode;
import patrones.creacion.builder.PurchaseOrder;
import java.util.ArrayList;
import java.util.Collection;
import java.util.List;
import javax.persistence.EntityManager;
import javax.persistence.EntityManagerFactory;
import patrones.creacion.builder.Customer;
import patrones.creacion.builder.jpacont.exceptions.IllegalOrphanException;
...
public class CustomerJpaController implements Serializable {
    ...
    public void CustomerJpaController(EntityManagerFactory emf){
        this.emf = emf;
        /*
        * TODO : constructor
        */
